function Segment(iwidth, iheight, color) {
	this.x = 0;
	this.y = 0;
	this.width = iwidth;
	this.height = iheight;
	...
	this.scaleX = 1;
	this.scaleY = 1;
	this.color = color; //(color === undefined) ? "#ffffff" : utils.parseColor(color);
	this.lineWidth = 1;
}
